...
#ifndef TESTRESULTS_SWIFT_H
#define TESTRESULTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestResults",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11TestResults25PETestResultsComponentAPI")
@interface PETestResultsComponentAPI : NSObject <PETestResultsComponentAPIProtocol>
...
- (UIViewController * _Nullable)getMOTestResultDetailsViewController:(PEPatientContext * _Nonnull)patientContext viewControllerTitle:(NSString * _Nullable)viewControllerTitle params:(NSDictionary<NSString *, NSString *> * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
