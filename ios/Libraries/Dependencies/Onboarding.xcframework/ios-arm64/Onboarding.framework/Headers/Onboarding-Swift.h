...
/// Component API for Onboarding
SWIFT_CLASS("_TtC10Onboarding24PEOnboardingComponentAPI")
@interface PEOnboardingComponentAPI : NSObject <PEOnboardingComponentAPIProtocol>
/// Get the pre-login view controller (welcome, notifications, location, org select)
/// <ul>
///   <li>
///     Returns the UIViewController that handles the pre-login onboarding
///   </li>
/// </ul>
- (UIViewController * _Nonnull)getPreLoginViewController SWIFT_WARN_UNUSED_RESULT;
/// Get the Home Page onboarding view controller
/// <ul>
///   <li>
///     Returns the UIViewController that handles the Home Page onboarding
///   </li>
/// </ul>
/// \param context The PEUserContext for the Home Page onboarding
///
/// \param onboardingDelegate The IOnboardingDelegate to call onboardingDismissed on when completed
///
...
/// Gets the 2FA optional view controller
/// <ul>
///   <li>
...
/// Gets the 2FA required view controller
/// <ul>
///   <li>
///     Returns a UIViewController instance of OnboardingWorkflowStepView for 2FA
///   </li>
...
/// Gets the terms and conditions view controller
/// <ul>
///   <li>
///     Returns a UIViewController instance of OrgTermsConditionsView
///   </li>
/// </ul>
/// \param onCompletion action performed on dismissal of the view
///
...
/// Gets the secondary login view controller
/// <ul>
///   <li>
///     Returns a UIViewController instance of SecondaryLoginSetupView
///   </li>
/// </ul>
/// \param onCompletion action performed on dismissal of the view
///
...
/// \param step member of onboardingSteps to add to the step array in MidLoginOnboardingWorkflow
///
- (void)addStepToMidLoginOnboardingWorkflowWithStep:(enum MidLoginOnboardingStep)step;
/// Clears the steps in the mid-login onboarding workflow
