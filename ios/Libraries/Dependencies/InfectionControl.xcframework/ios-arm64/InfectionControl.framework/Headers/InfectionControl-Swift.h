...
#ifndef INFECTIONCONTROL_SWIFT_H
#define INFECTIONCONTROL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InfectionControl",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// ViewController advising and confirming with the user to enable prelogin covid
SWIFT_CLASS("_TtC16InfectionControl39CovidPreloginConfirmationViewController")
@interface CovidPreloginConfirmationViewController : UIViewController
...
@interface CovidPreloginConfirmationViewController (SWIFT_EXTENSION(InfectionControl)) <IOnboardingNavigationDelegate>
- (void)actionTapped;
- (void)backTapped;
- (void)nextTapped;
- (void)playTapped;
...
/// Remove at iOS-13 and use PECore implementation
IB_DESIGNABLE
SWIFT_CLASS("_TtC16InfectionControl17ICSelfLoadingView")
@interface ICSelfLoadingView : UIView
...
SWIFT_CLASS("_TtC16InfectionControl30PEInfectionControlComponentAPI")
@interface PEInfectionControlComponentAPI : NSObject <PEInfectionControlComponentAPIProtocol>
