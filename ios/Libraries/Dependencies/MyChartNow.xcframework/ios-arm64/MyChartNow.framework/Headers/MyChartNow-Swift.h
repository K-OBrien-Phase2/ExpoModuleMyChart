...
#ifndef MYCHARTNOW_SWIFT_H
#define MYCHARTNOW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyChartNow",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10MyChartNow19NowSwitcherItemView")
@interface NowSwitcherItemView : UIView
...
SWIFT_CLASS("_TtC10MyChartNow15NowSwitcherView")
@interface NowSwitcherView : UIView <PEMyChartNowSwitcherProtocol>
@property (nonatomic) enum PEMyChartNowSwitcherContext currentContext;
...
SWIFT_CLASS("_TtC10MyChartNow24PEMyChartNowComponentAPI")
@interface PEMyChartNowComponentAPI : NSObject <PEMyChartNowComponentAPIProtocol>
...
- (BOOL)isCacheExpiredWithPatientContext:(PEPatientContext * _Nonnull)patientContext SWIFT_WARN_UNUSED_RESULT;
