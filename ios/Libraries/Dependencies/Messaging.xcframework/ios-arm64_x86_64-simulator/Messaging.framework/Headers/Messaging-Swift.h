...
#ifndef MESSAGING_SWIFT_H
#define MESSAGING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Messaging",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_RESILIENT_CLASS("_TtC9Messaging45InpatientConversationWebViewControllerManager")
@interface InpatientConversationWebViewControllerManager : MyChartWebViewControllerManager
...
SWIFT_CLASS("_TtC9Messaging23PEMessagingComponentAPI")
@interface PEMessagingComponentAPI : NSObject <PEMessagingComponentAPIProtocol>
...
- (UIViewController * _Nullable)getComposeBillingCustomerServiceViewController:(PEPatientContext * _Nonnull)patientContext forAccount:(NSString * _Nonnull)encryptedAccountID withType:(NSString * _Nonnull)encryptedBillingContext isExternal:(BOOL)isExternal SWIFT_WARN_UNUSED_RESULT;
