...
#ifndef MYDOCUMENTS_SWIFT_H
#define MYDOCUMENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyDocuments",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_RESILIENT_CLASS("_TtC11MyDocuments35MyDocumentsWebViewControllerManager")
@interface MyDocumentsWebViewControllerManager : MyChartWebViewControllerManager
...
SWIFT_CLASS("_TtC11MyDocuments25PEMyDocumentsComponentAPI")
@interface PEMyDocumentsComponentAPI : NSObject <PEMyDocumentsComponentAPIProtocol>
