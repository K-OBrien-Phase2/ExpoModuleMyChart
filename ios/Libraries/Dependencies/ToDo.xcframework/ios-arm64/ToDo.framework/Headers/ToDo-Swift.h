...
- (UIViewController * _Nullable)getLinkTaskDetailWebViewController:(PEPatientContext * _Nonnull)patientContext ltkId:(NSString * _Nonnull)ltkId ltkInstant:(NSString * _Nonnull)ltkInstant delegate:(id <PELinkTaskCompletionDelegate> _Nullable)taskCompletionDelegate SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
