...
#ifndef CARETEAM_SWIFT_H
#define CARETEAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CareTeam",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8CareTeam22PECareTeamComponentAPI")
@interface PECareTeamComponentAPI : NSObject <PECareTeamComponentAPIProtocol>
...
SWIFT_CLASS("_TtC8CareTeam12PinImageView")
