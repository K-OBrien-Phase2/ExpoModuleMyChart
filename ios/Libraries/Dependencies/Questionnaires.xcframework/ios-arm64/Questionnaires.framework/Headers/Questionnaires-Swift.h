...
#ifndef QUESTIONNAIRES_SWIFT_H
#define QUESTIONNAIRES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Questionnaires",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_RESILIENT_CLASS("_TtC14Questionnaires38QuestionnairesWebViewControllerManager")
@interface QuestionnairesWebViewControllerManager : MyChartWebViewControllerManager
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_RESILIENT_CLASS("_TtC14Questionnaires44QuestionnairesAnswerWebViewControllerManager")
@interface QuestionnairesAnswerWebViewControllerManager : QuestionnairesWebViewControllerManager
@end
...
SWIFT_CLASS("_TtC14Questionnaires26QuestionnairesComponentAPI")
@interface QuestionnairesComponentAPI : NSObject <PEQuestionnairesComponentAPIProtocol>
/// PEQuestionnairesComponentAPIProtocol
