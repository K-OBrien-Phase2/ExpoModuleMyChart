...
#ifndef VISITS_SWIFT_H
#define VISITS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Visits",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_RESILIENT_CLASS("_TtC6Visits34BedsideAvsWebViewControllerManager")
@interface BedsideAvsWebViewControllerManager : MyChartWebViewControllerManager
...
SWIFT_CLASS("_TtC6Visits20PEVisitsComponentAPI")
@interface PEVisitsComponentAPI : NSObject <PEVisitsComponentAPIProtocol>
