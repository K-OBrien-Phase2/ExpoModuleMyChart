...
#ifndef EDUCATION_SWIFT_H
#define EDUCATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Education",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)
typedef SWIFT_ENUM(NSInteger, EducationStatus, open) {
  EducationStatusUnread = 0,
  EducationStatusRead = 1,
  EducationStatusDone = 2,
  EducationStatusHidden = 3,
  EducationStatusQuestion = 4,
};


SWIFT_RESILIENT_CLASS("_TtC9Education33EducationWebViewControllerManager")
@interface EducationWebViewControllerManager : MyChartWebViewControllerManager
...
@class MyChartWebViewController;

/// This class implements <code>PEEducationComponentAPIProtocol</code>
SWIFT_CLASS("_TtC9Education23PEEducationComponentAPI")
@interface PEEducationComponentAPI : NSObject <PEEducationComponentAPIProtocol>
...
/// This method provides the first view controller for the Education component, in the outpatient case,
/// the list of all the assigned education titles in a current patientContenxt
/// \param patientContext An encounter context for a patient context
///
...
///
/// returns:
/// The component access result for inpatient education for the given context
...
///
/// returns:
/// The component access result for outpatient education for the given context
...
/// Get a MyChartWebViewController for the given education point
...
/// Get a MyChartWebViewController for the given education title
...
/// Gets the UIViewController for the MO activity page
/// \param patientContext An encounter context or a patient context
///
...
///
/// returns:
/// The MO view of the education activity page
